function [JA_1_0, JA_2_0, JA_3_0, JA_4_0, T_1_0, T_2_0, T_3_0, T_4_0, P_1_0, P_2_0, P_3_0, P_4_0] = cinematicaDiretaSCARA(P_1, P_2, P_3, P_4, elos)
    ...
    [col_Ja_1,T_1_0] = transformacoesCombinadas(zeros(4),D_1_0);
    P_1_0 = T_1_0(:,end);
    P_1_0(end,:) = [];

    R_y_q1 = RotacaoPura('y',q1);
    D_2_1 = TranslacaoPura(p_x_2,p_y_2,p_z_2);
    [col_Ja_2, T_2_0] = transformacoesCombinadas(T_1_0,R_y_q1,D_2_1);
    P_2_0 = T_2_0(:,end);
    P_2_0(end,:) = [];

    R_y_q2 = RotacaoPura('y',q2);
    D_3_2 = TranslacaoPura(p_x_3,p_y_3,p_z_3);
    [col_Ja_3, T_3_0] = transformacoesCombinadas(T_2_0,R_y_q2,D_3_2);
    P_3_0 = T_3_0(:,end);
    P_3_0(end,:) = [];

    D_4_3 = TranslacaoPura(p_x_4,p_y_4,p_z_4);
    R_y_q4 = RotacaoPura('y',q4);
    [col_Ja_4, T_4_0] = transformacoesCombinadas(T_3_0,D_4_3,R_y_q4);
    P_4_0 = T_4_0(:,end);
    P_4_0(end,:) = [];
