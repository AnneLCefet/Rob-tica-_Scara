...
% Definir os vetores das variáveis das juntas e suas derivadas
q = [q1; q2; q3];
...
% Jacobianos lineares e velocidades

JL1_0 = jacobian(p1_0,q); 
v1_0 = simplify(JL1_0*dq);
