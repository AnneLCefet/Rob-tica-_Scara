...
Ec = (L1^2*m1*dq1^2)/6 + (L1^2*m2*dq1^2)/2 + (L2^2*m2*dq1^2)/6 + (L2^2*m2*dq2^2)/6 + (L2^2*m2*dq1*dq2)/3 + (L1*L2*m2*cos(q2)*dq1^2)/2 + (L1*L2*m2*cos(q2)*dq1*dq2)/2;

Ep = g*m2*(L1*sin(q1) + (L2*sin(q1 + q2))/2) + (L1*g*m1*sin(q1))/2;
